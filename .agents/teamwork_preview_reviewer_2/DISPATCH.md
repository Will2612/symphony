# Dispatch for Reviewer 2 (Documentation Review)

## Identity
- Role: Documentation Reviewer 2
...
## Instructions
1. Independently review all 7 documentation files in `/home/will/Projects/symphony/docs/`:
...
2. Check technical accuracy, completeness, layout alignment, and Mermaid diagram syntactical validity across all files.
3. Write your detailed review to `/home/will/Projects/symphony/.agents/teamwork_preview_reviewer_2/analysis.md` and handoff report with verdict `APPROVE` or `REQUEST_CHANGES` to `/home/will/Projects/symphony/.agents/teamwork_preview_reviewer_2/handoff.md`.
